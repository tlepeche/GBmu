...
void Cpu_z80::_setCbOpcodeMap()
{
	_CBopcodeMap = {
		...
		(t_opcode){0x06, 0x00, 16, 16, 2, std::bind(&Cpu_z80::RLC_HL, this),  "RLC HL",	0x0000},
		...
		(t_opcode){0x46, 0x00, 16, 16, 2, std::bind(&Cpu_z80::BIT0_HL, this), "BIT 0 (HL)",	0x0000},
		...
		(t_opcode){0x4e, 0x00, 16, 16, 2, std::bind(&Cpu_z80::BIT1_HL, this), "BIT 1 (HL)",	0x0000},
		...
		(t_opcode){0x56, 0x00, 16, 16, 2, std::bind(&Cpu_z80::BIT2_HL, this), "BIT 2 (HL)",	0x0000},
		...
		(t_opcode){0x5e, 0x00, 16, 16, 2, std::bind(&Cpu_z80::BIT3_HL, this), "BIT 3 (HL)",	0x0000},
		...
		(t_opcode){0x66, 0x00, 16, 16, 2, std::bind(&Cpu_z80::BIT4_HL, this), "BIT 4 (HL)",	0x0000},
		...
		(t_opcode){0x6e, 0x00, 16, 16, 2, std::bind(&Cpu_z80::BIT5_HL, this), "BIT 5 (HL)",	0x0000},
		...
		(t_opcode){0x76, 0x00, 16, 16, 2, std::bind(&Cpu_z80::BIT6_HL, this), "BIT 6 (HL)",	0x0000},
		...
		(t_opcode){0x7e, 0x00, 16, 16, 2, std::bind(&Cpu_z80::BIT7_HL, this), "BIT 7 (HL)",	0x0000},
		...
		(t_opcode){0x86, 0x00, 16, 16, 2, std::bind(&Cpu_z80::RES0_HL, this), "RES 0 (HL)",	0x0000},
		...
		(t_opcode){0x8e, 0x00, 16, 16, 2, std::bind(&Cpu_z80::RES1_HL, this), "RES 1 (HL)",	0x0000},
		...
		(t_opcode){0x96, 0x00, 16, 16, 2, std::bind(&Cpu_z80::RES2_HL, this), "RES 2 (HL)",	0x0000},
		...
		(t_opcode){0x9e, 0x00, 16, 16, 2, std::bind(&Cpu_z80::RES3_HL, this), "RES 3 (HL)",	0x0000},
		...
		(t_opcode){0xa6, 0x00, 16, 16, 2, std::bind(&Cpu_z80::RES4_HL, this), "RES 4 (HL)",	0x0000},
		...
		(t_opcode){0xae, 0x00, 16, 16, 2, std::bind(&Cpu_z80::RES5_HL, this), "RES 5 (HL)",	0x0000},
		...
		(t_opcode){0xb6, 0x00, 16, 16, 2, std::bind(&Cpu_z80::RES6_HL, this), "RES 6 (HL)",	0x0000},
		...
		(t_opcode){0xbe, 0x00, 16, 16, 2, std::bind(&Cpu_z80::RES7_HL, this), "RES 7 (HL)",	0x0000},
		...
		(t_opcode){0xc6, 0x00, 16, 16, 2, std::bind(&Cpu_z80::SET0_HL, this), "SET 0 (HL)",	0x0000},
		...
		(t_opcode){0xce, 0x00, 16, 16, 2, std::bind(&Cpu_z80::SET1_HL, this), "SET 1 (HL)",	0x0000},
		...
		(t_opcode){0xd6, 0x00, 16, 16, 2, std::bind(&Cpu_z80::SET2_HL, this), "SET 2 (HL)",	0x0000},
		...
		(t_opcode){0xde, 0x00, 16, 16, 2, std::bind(&Cpu_z80::SET3_HL, this), "SET 3 (HL)",	0x0000},
		...
		(t_opcode){0xe6, 0x00, 16, 16, 2, std::bind(&Cpu_z80::SET4_HL, this), "SET 4 (HL)",	0x0000},
		...
		(t_opcode){0xee, 0x00, 16, 16, 2, std::bind(&Cpu_z80::SET5_HL, this), "SET 5 (HL)",	0x0000},
		...
		(t_opcode){0xf6, 0x00, 16, 16, 2, std::bind(&Cpu_z80::SET6_HL, this), "SET 6 (HL)",	0x0000},
		...
		(t_opcode){0xfe, 0x00, 16, 16, 2, std::bind(&Cpu_z80::SET7_HL, this), "SET 7 (HL)",	0x0000},
